...
(:init
	...
	(is-blocked pos32)
	(chef-at chef2 pos32);put_on_plate_station1
	(chef-available chef2)

	(station-next cutting_station1           pos21);pos11)
	(station-next put_on_plate_station1      pos21);pos20)

	;(station-next put_on_plate_station1 pos22);pos13)
	(station-next delivery_station1     pos22);pos14)

	(station-next put_on_plate_station2	pos23)
	(station-next cooking_station2      pos23)

	(station-next storage_room1         pos32);pos30)
	(station-next cooking_station1      pos31);pos41)

	;(station-next delivery_station2   	pos32);pos15)
	
	(station-next cutting_station2     pos33);pos11)
	'(station-next storage_room2        pos33);pos20)
	...
	;(item-at pasta2 storage_room2)
	
	;(item-at sauce1 storage_room2)
